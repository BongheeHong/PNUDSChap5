...
//char transfromLogicToChar(TypesOfData t) {
//	switch (t) {
//	case LogicalTrue: return 'T';
//	case LogicalFalse: return 'F';
//	case LogicalOr: return '|';
//	case LogicalAnd: return '&';
//	case LogicalNot: return '!';
//	default: throw "no such kind of notation";
//	}
//}

TypesOfData transfromCharToLogic(char c) {
	switch (c) {
	case 'T': return LogicalTrue;
	case 'F': return LogicalFalse;
	case '|': return LogicalOr;
	case '&': return LogicalAnd;
	case '!': return LogicalNot;
	default: return LogicalFalse;//special
	}
}
